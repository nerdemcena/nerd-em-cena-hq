...
const PREVIEW_CARDS = [
  {
    icon: Swords,
    tag: "// batalhas & quizzes",
    title: "Duelos & Quizzes Épicos",
    desc: "Competições de conhecimento geek, trivia de animes, debates acalorados e desafios interativos para a comunidade.",
    accent: "text-y",
  },
  {
    icon: Trophy,
...
export function TorneiosPage() {
  return (
    <div className="min-h-screen bg-blk font-nunito text-wh selection:bg-y selection:text-blk">
        ...
        <div className="relative z-10 mx-auto max-w-[960px] px-6">
          ...
          <div className="grid grid-cols-1 items-center gap-7 sm:grid-cols-[auto_1fr]">
            ...
            <div className="text-center sm:text-left">
              <div className="mb-2 inline-flex items-center gap-1.5 rounded-full bg-blk px-3 py-1 font-bebas text-[0.75rem] uppercase tracking-[0.16em] text-y">
              ...
              <h1 className="mb-2 font-bangers text-[clamp(2.6rem,6vw,4.2rem)] leading-[0.92] tracking-[0.04em] text-blk">
                ...
                <br />
                <span className="text-blk/90">Em Breve</span>
              </h1>
      ...
      <div className="dots-bg bg-blk py-16">
        <main className="mx-auto max-w-[960px] px-6">
          {/* HERO BANNER TEASER */}
          <div className="relative mb-16 overflow-hidden rounded-[20px] border-2 border-dashed border-y/30 bg-[#111100] p-8 text-center sm:p-12">
            <div className="absolute -top-2 left-6 h-[14px] w-[14px] rounded-full border-2 border-y/20 bg-blk" />
            <div className="absolute -top-2 right-6 h-[14px] w-[14px] rounded-full border-2 border-y/20 bg-blk" />
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <a
                ...
                className="inline-flex w-full items-center justify-center gap-2.5 rounded-[12px] border-2 border-blk/30 bg-y px-6 py-3.5 font-bebas text-[1rem] uppercase tracking-[0.14em] text-blk shadow-[3px_3px_0_rgba(255,140,0,0.6)] transition-all hover:-translate-y-1 hover:shadow-[5px_5px_0_rgba(255,140,0,0.6)] sm:w-auto"
              >
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
              {PREVIEW_CARDS.map((card, idx) => {
                ...
                return (
                  <div
                    key={card.title}
                    className={`relative rounded-[18px] border-2 border-dashed border-y/20 bg-[#111100] p-7 transition-all duration-300 hover:-translate-y-1.5 hover:border-y/50 hover:shadow-[0_20px_40px_-12px_rgba(255,214,0,0.15)] ${
                      idx % 2 === 0 ? "-rotate-1" : "rotate-1"
                    }`}
                  >
                    <div className="absolute -top-2 left-[22px] h-[12px] w-[12px] rounded-full border-2 border-y/20 bg-blk" />
                    <div className="absolute -top-2 right-[22px] h-[12px] w-[12px] rounded-full border-2 border-y/20 bg-blk" />
          ...
          <section className="rounded-[18px] border border-white/10 bg-black/50 p-8 text-center sm:p-10">
            ...
            <div className="mt-6">
              ...
              >
                <Crown className="h-4 w-4" /> Seguir no Instagram para não perder
              </a>
            </div>
          </section>
        </main>
        ...
        {/* FOOTER */}
        <footer className="mt-20 border-t border-y/20 bg-black/60 py-8 text-center">
          <Link
            to="/"
